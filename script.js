document.addEventListener("DOMContentLoaded", function() {
    ...
    const loginForm = document.getElementById("branding-login");
    ...
    loginForm.addEventListener("submit", function(event) {
        ...
        const email = document.getElementById("branding-username").value;
        const username = document.getElementById("branding-password").value;
